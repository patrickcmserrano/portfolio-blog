...
A elicitação é uma das etapas mais críticas, pois define **o que realmente precisa ser feito** antes de pensar em soluções tecnológicas. Não é só coletar informações, mas **descobrir necessidades implícitas** dos _stakeholders_.
