		...
		return [
			{
				...
				impact: $_('projects.intelligenceModule.impact') || [
			...
			},
			{
				...
				impact: $_('projects.paymentEnginePolylith.impact') || [
			...
			},
			{
				...
				impact: $_('projects.paymentEngineOnyx.impact') || [
			...
			},
			{
				...
				impact: $_('projects.paymentEngineIntegrations.impact') || [
			...
			},
			{
				...
				impact: $_('projects.authenticationSystem.impact') || [
			...
			},
			{
				...
				impact: $_('projects.zougueMpmsFullstack.impact') || [
			...
			},
			{
				...
				impact: $_('projects.zougueMpmsFrontend.impact') || [
			...
			},
			{
				...
				impact: $_('projects.realEstatePlatform.impact') || [
			...
			},
			{
				...
				impact: $_('projects.paymentGateway.impact') || [
