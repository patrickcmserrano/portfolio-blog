...
describe('HeroSection', () => {
  test('deve renderizar corretamente com os parâmetros fornecidos', () => {
    const { getByText } = render(HeroSection, {
      props: {
        ...
        description: 'Engenheiro de Software com foco em arquiteturas distribuídas e sistemas de pagamento.',
    ...
    expect(getByText('Engenheiro de Software com foco em arquiteturas distribuídas e sistemas de pagamento.')).toBeInTheDocument();
  ...
  test('deve conter os links corretos', () => {
    ...
    expect(getByText('Conheça minha trajetória').closest('a')).toHaveAttribute('href', '/base/about');
